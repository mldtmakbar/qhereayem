        ...
        <header className="backdrop-blur-md bg-white/10 border-b border-white/20">
          <div className="container mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">Kelola Booking</span>
            </div>
          </div>
        </header>
              ...
              <CardContent>
                <div className="space-y-2">
                  {recentHistory.map((history) => (
                    <div
                      key={history.id}
                      className="flex items-center justify-between backdrop-blur-sm bg-white/5 p-3 rounded-lg"
                    >
                      <div>
          ...
          <div className="space-y-6">
            {filteredBookings.length === 0 ? (
              ...
              filteredBookings.map((booking) => (
                <Card key={booking.id} className="backdrop-blur-md bg-white/10 border border-white/20 shadow-lg">
                  <CardHeader>
