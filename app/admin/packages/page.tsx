...
export default function AdminPackagesPage() {
  ...
  const handleAddPackage = () => {
    ...
    setFormData({ name: "", price: "", duration: "", maxPeople: "", description: "", items: "", features: "" })
        ...
        <header className="backdrop-blur-md bg-white/10 border-b border-white/20">
          <div className="container mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">Kelola Paket Adventure</span>
            </div>
          </div>
        </header>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-6 flex flex-col md:flex-row gap-4">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="backdrop-blur-md bg-black/80 border-white/20 text-white max-w-2xl">
                <DialogHeader>
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-24 backdrop-blur-sm bg-white/10 border border-white/20 rounded-md px-3 py-2 text-white"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-20 backdrop-blur-sm bg-white/10 border border-white/20 rounded-md px-3 py-2 text-white"
                      placeholder="Panduan pendakian&#10;Tips keamanan"
                    />
                  </div>
                  <div className="flex gap-2">
                    <Button onClick={handleAddPackage} className="bg-white/20 hover:bg-white/30 text-white">
                      Tambah
                    </Button>
                    <Button
                      variant="outline"
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {filteredPackages.map((pkg) => (
              <Card key={pkg.id} className="backdrop-blur-md bg-white/10 border border-white/20 shadow-lg">
                <CardHeader>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-1 text-xs">
                      {pkg.items.slice(0, 6).map((item: any, index: number) => (
                        <div
                          key={index}
                          className="flex items-center justify-between backdrop-blur-sm bg-white/5 p-2 rounded"
                        >
          ...
          <Dialog open={!!editingPackage} onOpenChange={() => setEditingPackage(null)}>
            <DialogContent className="backdrop-blur-md bg-black/80 border-white/20 text-white max-w-2xl">
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                ...
                <div className="flex gap-2">
                  <Button onClick={handleEditPackage} className="bg-white/20 hover:bg-white/30 text-white">
                    Simpan
                  </Button>
                  <Button
                    variant="outline"
